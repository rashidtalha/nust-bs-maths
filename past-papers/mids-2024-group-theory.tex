...
\begin{problem}{2 (ii)}
    ...
    TBC
    % \solution Suppose $a^{-1} b = h \in H$. Then, $b = ah$ for some $h \in H$. And, $a = bk$ with $k = h^{-1} \in H$. Therefore, $b \in aH$ and $a \in bH$.


    % Using ``$aH = bH \iff a \in bH$'' gives,
    % \begin{equation*}
    %     aH = bH
    %     \iff b \in aH
    ...
    % And EQQ is proved by noting that, Suppose $aH = bH$. By part (i) $a \in aH$. So, $a \in aH = bH$. Therefore, $a \in bH$.
