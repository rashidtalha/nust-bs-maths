...
\begin{negg}
    ...
    \end{equation}
    To eliminate $k$ from this equation, we need to use the constraint $\int_a^b \sqrt{1 + y'^2} \,dx = \ell$, which leads to a very complicated expression with no closed form solution.

    In the special case, $\ell = \pi a$, we have $k = 0$.
\end{negg}
