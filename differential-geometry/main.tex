...
\begin{proof}
    ...
    \begin{align}
        ...
        &= \bigg. \frac{1}{2} \sin (2t) G(t)^2 \bigg|_{0}^{\pi} - \int_{0}^{\pi} \cos 2t G^2 \,dt\\
        &= \int_{0}^{\pi} \paren*{\cos 2t - \sin 2t} G^2 \,dt.
    \end{align}
    Consequently,
    \begin{align}
        \int_{0}^{\pi} \paren*{\frac{dF}{dt}}^2 \,dt
...
\begin{nthm}[Isoperimetric inequality]
    Let $\gamma$ be a simple closed curve. Let $\ell(\gamma)$ denote its length and $A(\gamma)$ be the area enclosed by $\gamma$. Then,
    \begin{equation}
