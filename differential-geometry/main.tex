...
We observe that
\begin{equation}
    \kappa = \abs*{\ddot{\gamma}} = \abs*{\kappa_s \vec{n}_s} = \abs{\kappa_s}
\end{equation}
...
\begin{itemize}
    ...
    \item Its center is on the concave side of the curve. In other words, the center is located at $\gamma(a) + \rho\vec{n}$, where $\rho = 1/\kappa$ is the radius, and $\vec{n}$ is the unit normal vector at $\gamma(a)$.
\end{itemize}
